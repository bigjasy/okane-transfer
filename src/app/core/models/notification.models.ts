...
export interface MobileMoneyResponse { id: number; transferReference: string; operator: MobileMoneyOperator; status: MobileMoneyStatus; reconciliationStatus: ReconciliationStatus; operatorTransactionReference: string; walletPhoneNumber?: string; createdAt?: string; }
export interface MobileMoneyReconciliationRequest { operator: MobileMoneyOperator; date: string; }
export interface MobileMoneyReconciliationResponse { reconciled: number; mismatches: number; }
