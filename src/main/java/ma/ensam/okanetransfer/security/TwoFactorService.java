...
public class TwoFactorService {
    ...
    public TwoFactorService(OtpVerificationRepository otpVerificationRepository, PasswordEncoder passwordEncoder) {
    ...
    public OtpChallenge requestOtp(User user, OtpPurpose purpose, NotificationChannel channel) {
        ...
        return new OtpChallenge(saved.getId(), OTP_TTL.toSeconds(), otp);
    }
